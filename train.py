...
device = "mps" if torch.backends.mps.is_available() else "cpu"  # CPU isn't really practical here
...
def main():
    ...
    train_loader = SequenceLoader(data_folder=os.path.expanduser("~/torch_datasets/transformer_data"),
                                  source_suffix="en",
                                  target_suffix="de",
                                  split="train",
                                  tokens_in_batch=tokens_in_batch)
    val_loader = SequenceLoader(data_folder=os.path.expanduser("~/torch_datasets/transformer_data"),
                                source_suffix="en",
                                target_suffix="de",
                                split="val",
                                tokens_in_batch=tokens_in_batch)
